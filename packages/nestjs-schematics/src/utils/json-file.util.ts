/**
 * This file has been moved to the "ifit-nestjs-schematics" package to avoid pulling the entire "@schematics/angular" into iFIT projects.
...
export class JSONFile {
  ...
  modify (
    ...
    if (insertInOrder === undefined) {
      ...
      getInsertionIndex = (properties: string[]) => [...properties, property as string].sort().findIndex((p) => p === property)
